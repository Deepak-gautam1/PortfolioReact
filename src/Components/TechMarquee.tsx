...
const ICONS: Record<string, { path: string; color: string; darkColor?: string }> = {
  ...
  "Azure OpenAI": {
    color: "#00A67E",
    path: "M12 1.8a4.1 4.1 0 0 1 3.94 2.94 4.1 4.1 0 0 1 4.46 5.98 4.1 4.1 0 0 1-3.1 6.72 4.1 4.1 0 0 1-6.78 3.2 4.1 4.1 0 0 1-5.94-4.42 4.1 4.1 0 0 1-.92-7.32A4.1 4.1 0 0 1 12 1.8zm-.48 2.17a2.05 2.05 0 0 0-3.06 1.78v4.98l3.54-2.04 3.54 2.04V5.91a2.05 2.05 0 0 0-3.06-1.78zm5.54 3.06v4.08l3.52 2.03a2.05 2.05 0 0 0 .02-3.55zm-12.1 4.02a2.05 2.05 0 0 0 1 3.82l4.3-2.48-3.54-2.04zm7.04-.02-3.55 2.05v4.1L12 19.22l3.55-2.05v-4.1zm5.28 3.62-4.28 2.47v4.07a2.05 2.05 0 0 0 3.08-1.77zm-10.34 2.3a2.05 2.05 0 0 0 2.98 2.24v-4.1z",
  },
  "Azure Functions": {
    color: "#FBB040",
    path: "M13.05 4.24l.34 3.87-3.77 1.07 3.64 6.06L9.5 19.76H2.86l6.36-3.55-1.28-7.18zm2.38 2.23l-1.3 5.5 3.7 5.79H4.62l4.88-2.7-.97-5.5z",
  ...
  Outlook: {
    color: "#0078D4",
    path: "M2 5.5A2.5 2.5 0 0 1 4.5 3h15A2.5 2.5 0 0 1 22 5.5v13a2.5 2.5 0 0 1-2.5 2.5h-15A2.5 2.5 0 0 1 2 18.5zm2.2.3 7.8 5.35 7.8-5.35A.7.7 0 0 0 19.5 5h-15a.7.7 0 0 0-.3.8zm15.9 2.1-7.54 5.17a1 1 0 0 1-1.12 0L3.9 7.9v10.6c0 .38.31.7.7.7h14.8c.39 0 .7-.32.7-.7z",
  },
  "Zoho Creator": {
    color: "#E42527",
