      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="space-y-6">
            ...
            <p className="text-muted-foreground leading-relaxed">
              I now apply these skills as a full-time{" "}
              <strong>Data Engineer at Americana Restaurants</strong>. My role
              involves developing AI-powered analytics tools using cutting-edge
              technologies like GPT-4o and Azure AI Search. I build dynamic SQL
              query systems and enhance business intelligence pipelines,
              directly blending my passion for data with my drive to create
              solutions that deliver tangible impact.
            </p>
